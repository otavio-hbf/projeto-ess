    ...
    return (
        ...
        >
            <Typography style={{
                ...
                margin: "0 auto",
                alignContent: "center",
            }} level="h1">Em alta {<Icon path={mdiFire} size={2} />}</Typography><div className={styles.listContainer}>
                <h2 style={{ color: "white", marginBottom: "50px" }}>{genre ? `Top músicas do gênero ${genre}` : "Top músicas"}</h2>
                <h4 style={{ color: "white", marginBottom: "5px"}}>Filtre as top músicas por gênero</h4>
                ...
                {state.getHotSongsRequestStatus.maybeMap({
                    ...
                    failed: () => <span style={{color: "white"}}>Não há músicas com este gênero!</span>,
                    succeeded: (songs) => (
                        <>
                            <div className={styles.songList} style={{ display: "flex", marginTop: "30px" }}>
                                {songs.map((song) => (
