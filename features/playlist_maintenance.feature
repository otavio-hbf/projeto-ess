Feature: Playlist Library Maintenance
    ...
    Scenario: Playlist Creation
        Given I'm logged in with user "Pedro" and password "Password123" in the "Playlist Library" page
    ...
    Scenario: Playlist Deletion
        Given I'm logged in with user "BigT" and password "Password456" in the "Playlist Library" page
    ...
    Scenario: Adding a Song to a Playlist
        Given I'm logged in with user "Tavio" and password "Password678" accessing the music search page.
    ...
    Scenario: Excluding Songs from a Playlist
        Given I'm logged in with user "Leufa" and password "123Password" in the "Playlist Library" page
    ...
    Scenario: Failure in Updating Song in the Playlist
        Given I'm logged in with user "Ari" and password "123Password123" in the "Breakfast" playlist page
    ...
    Scenario: Failure in Playlist Deletion
        Given I'm logged in with user "Arthor" and password "456Password123" in the "Playlist Library" page
    ...
    Scenario: Reorganization of Song Order in a Playlist
        Given I'm logged in with user "Maria" and password "99Password00" in the "Playlist Library" page
    ...
    Scenario: Playlist Name Update
        Given I'm logged in with user "Luca" and password "678Password" in the "Playlist Library" page
